  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/dashboard/employee" element={<div className="flex items-center justify-center min-h-screen bg-gray-100"><span className="text-2xl text-gray-700">Employee Dashboard - Coming Soon</span></div>} />
